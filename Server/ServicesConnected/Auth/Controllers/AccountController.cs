...
namespace Server.ServicesConnected.Auth.Controllers
{
    [Authorize]
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<ApplicationUser> userManager,
            ...
            ILogger<AccountController> logger, IServiceProvider svp)
        {
        ...
        [Route("{lang}/[controller]/[action]/{returnUrl?}")]
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var isUnicName = await _checkUserNameIsUnic(model);
                if (!isUnicName)
                {
                    //todo  обработаь как то вью
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            else
            {
                ...
                return View("ExternalLogin", new ExternalLoginViewModel
                {
                    Email = email,
                    UserName = name,
                    ExternalProviderName = info.LoginProvider
        ...
        public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginViewModel model, string returnUrl = null)
        {
            if (ModelState.IsValid)
            {
                ...
                //          ViewBag.DefaultUserName = loginInfo.DefaultUserName;
                var isUnicName = await _checkUserNameIsUnic(model);
                if (!isUnicName)
                {
                    //todo  обработаь как то вью
        ...
        public async Task<IActionResult> ConfirmEmail(string userId, string code)
        {
            ...
            {
                return View("ConfirmEmailErrorNoData");
            }
            ...
            if (result.Succeeded)
            {
                try
                {
                    ...
                    var gameUserService = _svp.GetService<IGameUserService>();
                    var suc = gameUserService.CreateGameUserIfNotExist(user);
                    if (!suc)
                    {
                        throw new Exception();
                    }
                ...
                {
                    _logger.LogError(e, "game user not created registred user wasent be removed");
                    await _signInManager.SignOutAsync();
            ...
            return View("ConfirmEmailError", new CreateEmailMessageViewModel
            {
                Email = user.Email,
        ...
        [Route("[controller]/[action]")]
        [Route("{lang}/[controller]/[action]")]
        public IActionResult TestConfirmEmailCreateMailMessage()
        {
        ...
        private async Task<IActionResult> _confirmEmailCreateMailMessage(ApplicationUser user)
        {
            ...
            //   await _signInManager.SignInAsync(user, isPersistent: false);
            _logger.LogInformation("Mesagge for created user sended");
            return RedirectToAction(nameof(ConfirmEmailMessage), new { email = user.Email });
        ...
        [Route("[controller]/[action]")]
        [Route("{lang}/[controller]/[action]")]
        public IActionResult ConfirmEmailMessage(string email = null)
        {

            var mail = email ?? User.GetUserEmail();
            if (string.IsNullOrWhiteSpace(mail))
            {
                return RedirectToAction(nameof(Register));
            }
            return View("ConfirmEmailMessage", mail);
        }
