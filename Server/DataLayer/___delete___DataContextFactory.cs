...
namespace Server.DataLayer.Data
{
    ...
    /// url:https://weblog.west-wind.com/posts/2008/feb/05/linq-to-sql-datacontext-lifetime-management 
    ...
    public class DataContextFactory
    {
        ...
        {
            return Activator.CreateInstance<TDataContext>();
        }
        ...
        {
            if (HttpContext.Current != null)
                return (TDataContext) GetWebRequestScopedDataContextInternal(typeof(TDataContext), key,
                    connectionString);
